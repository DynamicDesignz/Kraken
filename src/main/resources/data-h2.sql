...
insert into password_list values (1, 'test.txt', 'UTF-8');
insert into password_list_job_delimiter_set values (1, 0, 2105248, 0);
insert into password_list_job_delimiter_set values (1, 1, 2818049, 2105248);
...
insert into candidate_value_list values ('test.txt', NULL);
insert into candidate_value_list_job_delimiter_set values ('test.txt', 2818049, 2105248 );
insert into candidate_value_list_job_delimiter_set values ('test.txt', 2105248, 0 );